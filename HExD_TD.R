...
}
{
  ...
  #components of the fit
    ...
    p1 <- p1 + geom_line(data=data.frame(lo), aes(lo$x,lo$y),color=4, lwd=lwd_env)
  ...
  suppressWarnings(ggsave(paste0('p',k,"_",Pep_Name,".jpeg"),p1,width=7,height=7))
...
###Finalize and Save Plot
{
  ...
  if(length(num_peptime)==2){
    ...
    row1 <- image_append(c(plot2,plot1))
    legend <- magick::image_read("Legend_1.jpeg")
    legend <- image_scale(legend,"2000")
    legend <- image_scale(legend,"x150")
    legend <- image_border(legend, "white", "300")
  ...
  if(length(num_peptime)==3){
    ...
    row1 <- image_append(c(plot2, plot3))
    row2 <- image_append(c(plot1))
    legend <- magick::image_read("Legend_1.jpeg")
    legend <- image_scale(legend,"2000")
    legend <- image_scale(legend,"x150")
    legend <- image_border(legend, "white", "300")
  ...
  if(length(num_peptime)==4){
    ...
    row1 <- image_append(c(plot2, plot3))
    row2 <- image_append(c(plot4,plot1))
    legend <- magick::image_read("Legend_1.jpeg")
    legend <- image_scale(legend,"2000")
    legend <- image_scale(legend,"x150")
    legend <- image_border(legend, "white", "300")
  ...
  if(length(num_peptime)==5){
    ...
    row1 <- image_append(c(plot2,plot3, plot4))
    row2 <- image_append(c(plot5, plot1))
    legend <- magick::image_read("Legend_1.jpeg")
    legend <- image_scale(legend,"2000")
    legend <- image_scale(legend,"x150")
  ...
  if(length(num_peptime)==6){
    ...
    row1 <- image_append(c(plot2,plot3,plot4))
    row2 <- image_append(c(plot5,plot6,plot1))
    legend <- magick::image_read("Legend_1.jpeg")
    legend <- image_scale(legend,"2000")
    legend <- image_scale(legend,"x150")
    legend <- image_border(legend, "white", "1500")
  ...
  if(length(num_peptime)==7){
    ...
    row1 <- image_append(c(plot2,plot3,plot4,plot5))
    row2 <- image_append(c(plot6,plot7,plot1))
    legend <- magick::image_read("Legend_1.jpeg")
    legend <- image_scale(legend,"2000")
    legend <- image_scale(legend,"x150")
  ...
  if(length(num_peptime)==8){
    ...
    row1 <- image_append(c(plot2,plot3, plot4,plot5))
    row2 <- image_append(c(plot6, plot7, plot8,plot1))
    legend <- magick::image_read("Legend_1.jpeg")
    legend <- image_scale(legend,"2000")
    legend <- image_scale(legend,"x150")
    legend <- image_border(legend, "white", "2500")
  ...
  if(length(num_peptime)==9){
    ...
    row3 <- image_append(c(plot8,plot9, plot1))
    legend <- magick::image_read("Legend_1.jpeg")
    legend <- image_scale(legend,"2000")
    legend <- image_scale(legend,"x150")
    legend <- image_border(legend, "white", "1500")
  ...
  if(length(num_peptime)==10){
    ...
    row1 <- image_append(c(plot2,plot3,plot4,plot5))
    row2 <- image_append(c(plot6,plot7,plot8, plot9))
    row3 <- image_append(c(plot10, plot1))
    legend <- magick::image_read("Legend_1.jpeg")
    legend <- image_scale(legend,"2000")
    legend <- image_scale(legend,"x150")
    legend <- image_border(legend, "white", "2500")
  ...
  if(length(num_peptime)==11){
    ...
    row1 <- image_append(c(plot2,plot3,plot4,plot5))
    row2 <- image_append(c(plot6,plot7,plot8,plot9))
    row3 <- image_append(c(plot10,plot11,plot1))
    legend <- magick::image_read("Legend_1.jpeg")
    legend <- image_scale(legend,"2000")
    legend <- image_scale(legend,"x150")
    legend <- image_border(legend, "white", "2500")
  ...
  if(length(num_peptime)==12){
    ...
    row1 <- image_append(c(plot2,plot3,plot4,plot5))
    row2 <- image_append(c(plot6,plot7,plot8,plot9))
    row3 <- image_append(c(plot10,plot11,plot12,plot1))
    legend <- magick::image_read("Legend_1.jpeg")
    legend <- image_scale(legend,"2000")
    legend <- image_scale(legend,"x150")
    legend <- image_border(legend, "white", "2500")
